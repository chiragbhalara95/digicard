...
<main class="app-content">
    <div class="app-title">
        <div>
            <h2 class="text-center">Quote Order List</h2>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item"><a href="{{route('business.lead-order-list')}}">Quote Order List</a></li>
        </ul>
    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0)" data-id="{{$data->id}}" class="btn btn-primary convert_to_order_btn">Convert To Order</a>
                                    @endif
                                </td>
                            </tr>
                            @php $i++ @endphp
