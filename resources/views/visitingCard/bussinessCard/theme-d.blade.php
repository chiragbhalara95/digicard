...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css">
    ...
    <link href="{{asset('public/visitingCard/bussinessCard/d/css/t2-style.css')}}" rel="stylesheet">
    <link href="{{asset('public/visitingCard/bussinessCard/d/css/all.css')}}" rel="stylesheet">
    <link href="{{asset('public/visitingCard/bussinessCard/d/css/custom.css')}}?v={{date('Ymdhis')}}" rel="stylesheet">
    <link href="{{asset('public/visitingCard/bussinessCard/d/css/intlTelInput.min.css')}}" rel="stylesheet">
...
<style>
        body {
            background-image: url(https://i.ibb.co/G0SQpvN/vintage-bg.jpg) !important;
        }
        .form-control {
            width: 100%;
            padding: 10px;
      ...
      <div class="upper">
        ...
        @endif
          ...
          @if (!empty($companyInfoData->company_name))
            ...
            <div style="width: 40%;background-color: #F17D3A;height:2px;"></div>
         ...
         <span style="margin-top: 5px;display: block"><i style="font-size: 12px;">{!! $companyInfoData->company_profession !!}</i></span>
        @endif
         ...
         <div class="contact-buttons">
            ...
            <div class="firmname" style="margin-top:25px;margin-bottom:0px;">GST No: {!! $companyInfoData->gst_number !!}</div>
     ...
     <div class="lower" style="margin-top:20px;">
            <table class="contact-action-table">
               <tbody>
                  ...
                  <tr>
                     <td>
                        <a target="_blank" href="https://g.co/kgs/5eoK8D">
                  ...
                  @endif
                                  ...
                                  <tr>
                     <td>
                        <a href="/cdn-cgi/l/email-protection#184b706a6d767f796a36776a7679757d766c29587f75797174367b7775">
                        <i class="fas fa-envelope contact-action-container-icon"></i>
                        </a>
                     </td>
                     <td>
                        <a href="mailto:{{$userObj->email}}" class="contact-action-container-text">
                        <span class="__cf_email__" data-cfemail="eebd869c9b80898f9cc0819c808f838b809adfae89838f8782c08d8183">{{$userObj->email}}</span>                        </a>
                     </td>
                  </tr>
                                  <tr>
                     <td>
                     ...
                     <td>
                        ...
                        {{$companyInfoData->country_code}}{{$companyInfoData->company_mobile}}                        </a>
          ...
          <input type="text" readonly="" class="form-control" value="{{$vistingUrl}}" id="visitingUrlText">
              ...
              <div class="row">
                  <div class="col float-start">
                          <a href="javascript::void(0)" class="buttonCopy col-md-4 text-left text-items-align-left shadow-button" onclick="copyUrlSecond()">Copy&nbsp;<i class="fa fa-copy" aria-hidden="true"></i></a>
                  </div>
                  <div class="col float-end">
                          <a class="col-md-6 text-center big_btns text-white text-end shadow-button" href="{{url('downloadQrCode')}}/{{$userObj->slug}}" >Download QR Code &nbsp;<i class="fa fa-download"></i></a>  
                  </div>
              </div>
      ...
      <div class="section-content-wrapper">
        ...
        @foreach($galleryData as $galleryDetail)
          <div class="card filter {{$galleryDetail->category_name}}">
            ...
            @if($userConfigObj->isEcommerceEnable == '1')
            <div class="buy_ele">
              <a href="javascript:void(0)" class="buyNowBtn product-enquiry-btn text-center" data-id="{{$galleryDetail->id}}" data-product="{{$galleryDetail->title}}" data-price="{{$price}}"><i class="fab fa-first-order"></i>&nbsp;Buy Now</a>

              <a href="javascript:void(0)" class="add product-enquiry-btn text-center" data-id="{{$galleryDetail->id}}" data-product="{{$galleryDetail->title}}" data-price="{{$price}}"><i class="fa fa-shopping-cart"></i>&nbsp;Add to cart</a>
            </div>
            @else
            <a href="{{$link}}" target='_blank' class="product-enquiry-btn text-center"><div class="btn_buy"><i class="fab fa-whatsapp"></i>&nbsp;{{$userConfigObj->enquiryLabel}}</div></a>
            @endif
        </div>
