...
<link href="{{asset('public/visitingCard/bussinessCard/d/css/font-awesome.min.css')}}" rel="stylesheet">
<link href="{{asset('public/visitingCard/bussinessCard/d/css/template4.css')}}" rel="stylesheet">
<link href="{{asset('public/visitingCard/bussinessCard/d/css/fonts.css')}}" rel="stylesheet">
<link href="{{asset('public/visitingCard/bussinessCard/d/css/star-rating.css')}}" rel="stylesheet">
...
<script>
    document.documentElement.style.setProperty('--theme-color', '#6d126f');
...
<div class="main-wrapper" id="home">
    ...
    <div class="companylogo">
        @if(!empty($companyInfoData->company_logo))
          <img src="{{url('public')}}/{{$companyInfoData->company_logo}}" class="profile-pic-img img-responsive">
        @endif
    </div>
  ...
  @if($userConfigObj->isShowNoOfVisit == '1')
    ...
    <div class="headerbg">
      ...
      <a class="contact-icon" target="_blank" href="https://maps.google.com?q={{$companyInfoData->latitude}},{{$companyInfoData->longitude}}&z=12&amp;um=1&amp;ie=UTF-8&amp;sa=X&amp;ved=2ahUKEwiWyNX76N3qAhWrzTgGHQuCBicQ_AUoAXoECCMQAw">
            ...
            <a class="contact-icon yellow" target="_blank" href="mailto:{{$userObj->email}}">
            ...
            <tbody>
              @if (!empty($companyInfoData->company_address))
                ...
                <tr>
                    ...
                    <td><a target="_blank" href="https://maps.google.com?q={{$companyInfoData->latitude}},{{$companyInfoData->longitude}}&z=12&amp;um=1&amp;ie=UTF-8&amp;sa=X&amp;ved=2ahUKEwiWyNX76N3qAhWrzTgGHQuCBicQ_AUoAXoECCMQAw"> <i class="fa fa-map-marker inside-icon"></i> </a></td>

                    <td><a target="_blank" href="https://maps.google.com?q={{$companyInfoData->latitude}},{{$companyInfoData->longitude}}&z=12&amp;um=1&amp;ie=UTF-8&amp;sa=X&amp;ved=2ahUKEwiWyNX76N3qAhWrzTgGHQuCBicQ_AUoAXoECCMQAw" class="contact-text">{!!rtrim(preg_replace('#<p(.*?)>(.*?)</p>#is', '$2<br/>', $companyInfoData->company_address), "<br/>");!!}</a></td>
...
<div class="page-container" id="aboutus">
    ...
    <a class="download" href="../demo-templates/images/eDesignGuru%20Flyer.pdf" download="">
...
<div class="page-container" id="products-services">
    ...
    <div>
        ...
        <div class="card">
            ...
            <img onclick="openImageModal(this)" alt="Website Design &amp; Development" src="./Digital Visiting Card _ Digital Business Card_files/web-design-and-development.jpg" style="width:100%;margin-bottom: 15px;">
        ...
        <div class="card">
            ...
            <img onclick="openImageModal(this)" alt="Graphic Design" src="./Digital Visiting Card _ Digital Business Card_files/graphic-design.jpg" style="width:100%;margin-bottom: 15px;">
        ...
        <div class="card">
            ...
            <img onclick="openImageModal(this)" alt="Logo Design &amp; Branding" src="./Digital Visiting Card _ Digital Business Card_files/logo-design.jpg" style="width:100%;margin-bottom: 15px;">
        ...
        <div class="card">
            ...
            <img onclick="openImageModal(this)" alt="Digital Marketing" src="./Digital Visiting Card _ Digital Business Card_files/digital-marketing.jpg" style="width:100%;margin-bottom: 15px;">
...
<div class="page-container" id="videogallery">
    ...
    <div>
        ...
        <div class="card" style="padding: 10px">
            ...
            <iframe src="./Digital Visiting Card _ Digital Business Card_files/qyekpPUBOJU.html" frameborder="0" allowfullscreen="" style="width: 100%"></iframe>
...
<div id="shareModal" class="modal share-modal">
    ...
    <div class="share-form fadeInUpBig">
        ...
        <div class="share-form-buttons-container">
            ...
            <div class="share-btn-heading"> <img src="./Digital Visiting Card _ Digital Business Card_files/tild-arrow.svg" class="share-btn-arrow" alt="">
