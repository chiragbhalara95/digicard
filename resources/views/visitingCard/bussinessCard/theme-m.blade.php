...
<link href="{{asset('public/visitingCard/bussinessCard/common/css/gallery-category.css')}}" rel="stylesheet">
    ...
    <link href="{{asset('public/visitingCard/bussinessCard/m/css/feedback.css')}}" rel="stylesheet">
    <link href="{{asset('public/visitingCard/bussinessCard/m/css/css2.css')}}" rel="stylesheet">
    <link href="{{asset('public/visitingCard/bussinessCard/m/css/mobile_css.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('public/visitingCard/bussinessCard/m/css/slider.css')}}">
    <link rel="stylesheet" href="{{asset('public/visitingCard/bussinessCard/m/css/style.css')}}">
    ...
    <script src="{{asset('public/visitingCard/bussinessCard/m/js/master_js.js')}}"></script>
    <script src="{{asset('public/visitingCard/bussinessCard/m/js/flickity-docs.min.js')}}"></script>
