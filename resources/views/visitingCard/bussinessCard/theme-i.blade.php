...
<html>
    ...
    <link href="{{asset('public/visitingCard/bussinessCard/i/css/awesome.min.css')}}" rel="stylesheet">
    <link href="{{asset('public/visitingCard/bussinessCard/i/css/cart.css')}}" rel="stylesheet">
    <link href="{{asset('public/visitingCard/bussinessCard/i/css/feedback.css')}}" rel="stylesheet">
    <link href="{{asset('public/visitingCard/bussinessCard/i/css/css2.css')}}" rel="stylesheet">
    <link href="{{asset('public/visitingCard/bussinessCard/i/css/mobile_css.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{asset('public/visitingCard/bussinessCard/i/css/slider.css')}}">
    <link rel="stylesheet" href="{{asset('public/visitingCard/bussinessCard/i/css/style.css')}}">
    ...
    <script src="{{asset('public/visitingCard/bussinessCard/i/js/master_js.js')}}"></script>
    <script src="{{asset('public/visitingCard/bussinessCard/i/js/flickity-docs.min.js')}}"></script>
