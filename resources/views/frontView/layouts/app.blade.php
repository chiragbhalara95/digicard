...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   <head>
      ...
      <!-- Favicons -->
      <link href="{{ asset('public/frontView/assets/img/logo.png') }}" rel="icon">
      <link href="{{ asset('public/frontView/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
      <!-- Google Fonts -->
      ...
      <header id="header" class="fixed-top">
         <div class="container">
            <div class="logo float-left">
               ...
               <a href="{{url('/')}}"><img src="{{ asset('public/frontView/assets/img/logo.png') }}" alt="" class="img-fluid"></a>
            </div>
